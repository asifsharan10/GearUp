...
<body>
    ...
    <main class="page lanidng-page">
        <section style="background:  rgb(13,13,13);color: rgb(13,13,13);">
            <div class="container">
                <div class="row">
                    {% for acs in accessories %}
                    <div class="col-lg-4" style="padding-bottom: 30px;padding-top: 30px;">
                        <div class="card card-hov" style="background-color: #214252; border-radius: 8px;height: 550px">
                            <a href="{% url \'accessory\' acs.id %}">
                                <img class="card-img-top" width="288px" height="230px"
                                    style="border-radius: 8px 8px 0px 0px;" src="{{acs.image_url1}}" alt="">
                            </a>
                            <div class="card-body ">
                                <a href="{% url \'accessory\' acs.id %}" style="color: white; text-decoration: none; ">
                                    <h5 class="card-title">{{acs.name}}</h5>
                                </a>
        ...
        <section class="portfolio-block skills" style="color: rgb(13,13,13);background: rgb(13,13,13);">
            <div class="container">
                ...
                <h2 style="text-align: center;color: rgb(255,255,255);">Our Services</h2>
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-hov special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Authentic accessories and new models are updated. Quality is our
                                    first priority.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-hov special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">We provide the best deals in the country you can get to buy your
                                    dream car.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-hov special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">we provide 100% security with EMI system available to make smooth
                                    transaction.</p>
                            </div>
                        </div>
                    </div>
